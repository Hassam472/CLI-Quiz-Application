...
console.log(chalk.bgYellow.bold.whiteBright("Welcome to TypeScript Quiz Exam"));
...
while (quiz_Answer.seeResult) {
    ...
    console.log(chalk.bold.bgYellow.italic(`Your Score is ${chalk.whiteBright(score / 50 * 100, '%')}`));
}
